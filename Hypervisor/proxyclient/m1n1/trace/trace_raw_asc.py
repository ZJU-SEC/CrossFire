...
from m1n1.fw.asc.mgmt import ManagementMessage, Mgmt_EPMap, Mgmt_EPMap_Ack, Mgmt_StartEP, Mgmt_SetAPPower, Mgmt_SetIOPPower, Mgmt_IOPPowerAck
class Management(EP):
...
from m1n1.fw.asc.syslog import SyslogMessage, Syslog_Init, Syslog_GetBuf, Syslog_Log
...
ascTracer = ASCTracer(hv, "/arm-io/gfx-asc", verbose=1)
ascTracer.start()